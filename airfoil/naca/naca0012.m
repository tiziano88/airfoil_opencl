...
%disp ('hello world %d', nnodes);

fprintf (1,'Computing the mesh numnodes = %d, numcells = %d, numedges = %d\n', nnodes, ncells, nedges);
...
%
%disp ('hello world');
fprintf (1,'Outputting the result numnodes = %d, numcells = %d, numedges = %d\n', nnodes, ncells, nedges);
...
fname = [ 'new_grid_'  num2str(ncells) '.dat' ];
